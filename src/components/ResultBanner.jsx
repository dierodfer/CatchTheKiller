...
// Desenlace de victoria: quién es el asesino y dónde ocurrió. `revealed`
// distingue haber resuelto el caso de haber pedido ver la solución.
function WinBody({ result, characters, revealed, reduce, delay }) {
  return (
    <>
      <motion.div
      ...
      <p className="mt-4 text-[15px] leading-relaxed text-plum-800">
        El asesino es <span className="font-semibold text-gold-deep">{result.killer}</span>: era el
